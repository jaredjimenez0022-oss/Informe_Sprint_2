...
\input{project/abstract.tex} % adds the abstract page
\newpage
...
\input{project/srs.tex} % Especificación de requerimientos
\input{project/system-design.tex} % Diseño del sistema
\input{project/prototypes.tex} % Prototipos de interfaz de usuario
\input{project/testing.tex} % Pruebas
\input{project/screenshots.tex} % [OPCIONAL] Capturas de pantalla
\input{project/conclusion.tex} % Conclusiones del informe
\input{project/ref.tex} % Referencias bibliográficas
